    ...
    <DashboardLayout current={1}>
      <div className="w-full bg-white flex flex-col py-11 ">
        <div className="flex justify-between items-center px-10  ">
          <p className="text-xl text-rpmary font-medium">List of admins</p>
        ...
        <table className="min-w-max w-full table-auto border-collapse block md:table overflow-hidden lg:overflow-scroll">
          <th className="grid w-full grid-cols-4  border-b border-b-[#f3f3f3] py-5 px-10">
            <td className="text-neutral text-sm text-start ">Name</td>
            <td className="text-neutral text-sm text-start ">Email</td>
            <td className="text-neutral text-sm text-start ">Role</td>
            <td className="text-neutral text-sm text-start ">Status</td>
          </th>
          <tbody>
